...
namespace MvcAdmin.Core
{
    ...
    {
        public static string connectionString = ConfigurationManager.ConnectionStrings["MSSQLString"].ConnectionString;
        ...
        //        SqlParameter myParameter = new SqlParameter("?fs", SqlDbType.Blob);
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>SqlDataReader</returns>
        public static SqlDataReader ExecuteReader(string SQLString, params  Object[] cmdParms)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        /// <returns>SqlDataReader</returns>
        public static SqlDataReader RunProcedure(string storedProcName, Object[] parameters)
        {
            SqlConnection connection = new SqlConnection(connectionString);
